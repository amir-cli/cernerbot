...
function tdcli_update_callback(data)
  ...
  if (data.ID == "UpdateNewMessage") then
    ...
    if msg.content_.ID == "MessageText" then
      ...
      if input:match('^demoteowner (.*)') and is_sudo(msg) then
        redis:del('owners:'..chat_id)
...
tdcli.sendText(chat_id, 0, 0, 1, nil, 'Group No Mo', 1, 'md')
end
...
tdcli.sendText(chat_id, 0, 0, 1, nil, text, 1, 'md')
      ...
      if input:match("^[Aa]dd$") and is_sudo(msg) then
        ...
        tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'SuperGroup Has Been Added', 1, 'md')
      end
      -----REM
      ...
      if input:match('^silent') then
        if redis:scard('muteusers:'..chat_id) == 0 then
          tdcli.sendText(chat_id, 0, 0, 1, nil, 'no Silent User', 1, 'md')
        end
      ...
      if input:match("^unlock links$")  and is_mod(msg) and groups then
        if not redis:get('lock_linkstg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'links Has Been unLocked', 1, 'md')
        end
      end
      --lock username
      groups = redis:sismember('groups',chat_id)
      if input:match("^lock username$") and is_mod(msg) and groups then
        if redis:get('usernametg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Username Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock username$") and is_mod(msg) and groups then
        if not redis:get('usernametg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Username Has Been unLocked', 1, 'md')
        end
      end
      --lock tag
      groups = redis:sismember('groups',chat_id)
      if input:match("^lock tag$") and is_mod(msg) and groups then
        if redis:get('tagtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Tag Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock tag$") and is_mod(msg) and groups then
        if not redis:get('tagtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, ' Tag Has Been UnLocked', 1, 'md')
        end
      end
      --lock fwd
      groups = redis:sismember('groups',chat_id)
      if input:match("^lock fwd$") and is_mod(msg) and groups then
        if redis:get('fwdtg:'..chat_id) then
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Forward is already Locked', 1, 'md')
        else
          redis:set('fwdtg:'..chat_id, true)
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Forward Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock fwd$") and is_mod(msg) and groups then
        if not redis:get('fwdtg:'..chat_id) then
          ...
          redis:del('fwdtg:'..chat_id)
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Forward Has Been UnLocked', 1, 'md')
        end
      end
      --arabic/persian
      groups = redis:sismember('groups',chat_id)
      if input:match("^lock arabic$") and is_mod(msg) and groups then
        if redis:get('arabictg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Persian/Arabic Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock arabic$") and is_mod(msg) and groups then
        if not redis:get('arabictg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Persian/Arabic Has Been UnLocked', 1, 'md')
        end
      end
      ---english
      groups = redis:sismember('groups',chat_id)
      if input:match("^lock english$") and is_mod(msg) and groups then
        if redis:get('engtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'English Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock english$") and is_mod(msg) and groups then
        if not redis:get('engtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'English Has Been UnLocked', 1, 'md')
        end
      end
      --lock foshtg
      groups = redis:sismember('groups',chat_id)
      if input:match("^[#!/]lock fosh$") and is_mod(msg) and groups then
        if redis:get('badwordtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Fosh Has Been Locked', 1, 'md')
        end
      end
      if input:match("^[#!/]unlock fosh$") and is_mod(msg) and groups then
        if not redis:get('badwordtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Fosh Has Been UnLocked', 1, 'md')
        end
      end
      --lock edit
      groups = redis:sismember('groups',chat_id)
      if input:match("^lock edit$") and is_mod(msg) and groups then
        if redis:get('edittg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Edit Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock edit$") and is_mod(msg) and groups then
        if not redis:get('edittg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Edit Has Been UnLocked', 1, 'md')
        end
      end
       --lock emoji
      groups = redis:sismember('groups',chat_id)
      if input:match("^lock emoji") and is_mod(msg) and groups then
        if redis:get('emojitg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Emoji Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock emoji$") and is_mod(msg) and groups then
        if not redis:get('emojitg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Emoji Has Been UNLocked', 1, 'md')
        end
      end
      --- lock inline
      groups = redis:sismember('groups',chat_id)
      ...
      if input:match("^unlock inline$") and is_mod(msg) and groups then
        if not redis:get('inlinetg:'..chat_id) then
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'lnline is already Not Locked', 1, 'md')
        else
      ...
      if input:match("^lock flood") and is_mod(msg) and groups then
        if redis:get('floodtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Flood Has Been Locked', 1, 'md')
        end
      end
      if input:match("^unlock flood$") and is_mod(msg) and groups then
        if not redis:get('floodtg:'..chat_id) then
          ...
          tdcli.sendText(chat_id, msg.id_, 0, 1, nil, 'Reply Hass Been unLocked', 1, 'md')
        end
      end
      ...
      if input:match("^[Ss]ettings$") and is_mod(msg) then
        ...
        .."*Lock Inline*".."`"..inline..'`'..'\n'
        .."*Lock Emoji *".."`"..emoji..'`'..'\n'
if input:match("^muteslist$") and is_mod(msg) then
        local text = "mute List :".."\n"
        .."*Mute All : *".."`"..All.."`".."\n"
    ...
    if input:match("^[Ii]nvite") and is_sudo(msg) then
      ...
      if input:match("^[Cc]reategpsup") and is_sudo(msg) then
    ...
    if redis:get('fwdtg:'..chat_id) and msg.forward_info_ and not is_mod(msg) then
      tdcli.deleteMessages(chat_id, {[0] = msg.id_})
    end
    local is_link_msg = input:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or input:match("[Tt].[Mm][Ee]/") or input:match("https") or input:match("https://t.me/")
